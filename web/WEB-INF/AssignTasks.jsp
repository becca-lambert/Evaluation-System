        ...
        <Pre>
         <form method="POST" action="AddTask">  
            ...
            <table>  
               ...
               <label for="datepicker">Date of schedule :</label>
                <input type="text" name="dob" id="datepicker">
                
                <br>
            
             <label for="bakes7">Backroom Restock:</label>
            <select name="br" id="br">
             ...
             <br>
                ...
                <label for="bakes6">Kitchen :</label>
            ...
            <select name="bar" id="bar">
                ...
                <option value="rossgeller">Ross Geller</option>
                     ...
                     <br> 
                  <label for="bakes2">Service :</label>
            <select name="service" id="service">
                ...
                <option value="rossgeller">Ross Geller</option>
                  ...
                  <br>
                             <label for="bakes3">Day Off :</label>
