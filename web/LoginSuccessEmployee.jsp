    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         <h4 class="w3-center">USER ID: 13892 </h4>
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Job Title : Bar Employee</p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Branch: Bristol</p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> Joined company on: 14-10-2019 </p>
        </div>
      </div>
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">WELCOME USER: BECCA</h6>
                          </div>
          </div>
        </div>
      </div>
        ...
        <h4>Your Options:</h4> 
            ...
            <input type="radio" name="option" value="ViewStats">View your Evaluation data  <br>
